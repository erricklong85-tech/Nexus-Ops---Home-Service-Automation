...
export default function WebsiteDesignPage({ onOpenContact }: PageProps) {
  return (
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 w-full pt-20 flex flex-col justify-center h-full">
          <div className="max-w-4xl">
            <motion.p
              ...
              className="text-gray-400 font-bold tracking-[0.2em] text-sm uppercase mb-6"
            >
            ...
            <motion.h1
              ...
              className="text-4xl md:text-5xl lg:text-7xl font-black uppercase italic leading-[0.95] mb-6"
            >
              &quot;Incredibly thorough and detailed with the entire process&quot;
            </motion.h1>
            ...
            <motion.p
              ...
              className="text-xl md:text-2xl font-bold uppercase text-white mb-12"
            >
              - Justin Puetz, Puetz Construction
            </motion.p>
            ...
            >
              ...
              <div className="flex items-start gap-4 group">
                ...
                <span className="text-lg md:text-xl font-medium pt-1">
                  Developed to be mobile-friendly, responsive, & fast!
                </span>
              </div>
            </motion.div>
